...
struct ChessBoard
{
    ...
    void reset()
    {
        ...
        white_pieces[Pos(4, 8)] = Piece::king;
        white_pieces[Pos(5, 8)] = Piece::queen;
        black_pieces[Pos(4, 1)] = Piece::king;
        black_pieces[Pos(5, 1)] = Piece::queen;
    ...
    void printBoard()
    {
        ...
        static map<Piece, char> sprites = {{Piece::white_pawn, 'P'}, {Piece::black_pawn, 'p'}, {Piece::rook, 'R'}, {Piece::knight, 'N'}, {Piece::bishop, 'B'}, {Piece::king, 'K'}, {Piece::queen, 'Q'}};
        cout << endl
